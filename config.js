...
module.exports = {
    ...
    BOT: process.env.BOT_NAME === undefined ? '👩‍🦰Amazone' : process.env.BOT_NAME,
    ...
    WEL_GIF: process.env.WEL_GIF === undefined ? '' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? '' : process.env.GIF_BYE,
