...
module.exports = {
    ...
    TAPI1: process.env.TAPI1 === undefined ?'TEENUU1' : process.env.TAPI1,
    TAPI2: process.env.TAPI2 === undefined ?'TEENUU2' : process.env.TAPI,
    TAPI3: process.env.TAPI3 === undefined ?'TEENUU3' : process.env.TAPI,
    TAPI4: process.env.TAPI4 === undefined ?'TEENUU3' : process.env.TAPI,
