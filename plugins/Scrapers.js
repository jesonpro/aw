...
if (config.WORKTYPE == 'private') {
    ...
    Neotro.addCommand({pattern: 'das ?(.*)', fromMe: true, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
    ...
    Neotro.addCommand({pattern: 'das ?(.*)', fromMe: false, desc: Lang.VIDEO_DESC}, (async (message, match) => { 
