...
var respoimage = await axios.get(`${Config.SITE}68907`, { responseType: 'arraybuffer' })
...
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}68908`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});

    }));
Neotro.addCommand({pattern: 'xvo3 ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}68911`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});

    }));
Neotro.addCommand({pattern: 'xvo4 ?(.*)', fromMe: tn, dontAddCommandList: true}, (async (message, match) => {
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}68913`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});
...
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}68914`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});
...
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}68917`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});
...
await message.client.sendMessage(message.jid,UP,MessageType.text);
var respoimage = await axios.get(`${Config.SITE}`, { responseType: 'arraybuffer' })
await message.client.sendMessage(message.jid,Buffer.from(respoimage.data), MessageType.audio, {mimetype: Mimetype.mp4Audio, ptt: true, quoted: message.data});
